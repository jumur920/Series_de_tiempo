...
ggplot(df_grafica_log, aes(x = Fecha, y = Valor, color = Tipo)) +
  ...
  labs(title = "Suavizamiento Exponencial Simple (log(y)): Últimos 7 días y pronóstico",
...
ggplot(df_grafica, aes(x = Fecha, y = Valor, color = Tipo)) +
  ...
  geom_ribbon(data = subset(df_grafica, Tipo == "Pronóstico"), 
              aes(ymin = Lower, ymax = Upper), alpha = 0.2, fill = "blue") +
  labs(title = enc2utf8("Holt-Winters Aditivo: Últimos 7 días y pronóstico"),
...
ggplot(df_grafica, aes(x = Fecha, y = Valor, color = Tipo)) +
  ...
  geom_ribbon(data = subset(df_grafica, Tipo == "Pronóstico"), 
              aes(ymin = Lower, ymax = Upper), alpha = 0.2, fill = "blue") +
  labs(title = enc2utf8("Holt-Winters Multiplicativo: Últimos 7 días y pronóstico"),
       x = "Fecha", y = "Valor total",
       color = "Tipo") +
  theme_minimal()
